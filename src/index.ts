...
async function initEvents() {
    ...
    if (myEvents.events.length === 0) {
        myEvents.add(new DiscordEvent("Hourly Event", 60 * 60, "393577466452508684", Date.now()))

        myEvents.add(new DiscordEvent("Daily Event", 60 * 60 * 24, "1092176267979272273", Date.now()))
    }
